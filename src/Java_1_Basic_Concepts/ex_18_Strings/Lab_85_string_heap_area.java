...
public class Lab_85_string_heap_area {
    public static void main(String[] args) {
        ...
        String s2 = new String("Javatpoint"); //This will create another new place in object area
        String s3 = "Pythonpoint"; // This will be created in String constanct pool (SCP) area.
        String s4 = "Pythonpoint"; // Here no new place will be created for Pythonpoint. Exsisting will be assinged again.
